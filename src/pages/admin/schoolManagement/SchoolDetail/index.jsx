...
const SchoolDetail = () => {
  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      try {
        ...
        const errorMessage = err?.response?.data?.message || err?.message || 'Không thể tải thông tin trường học';
  ...
  if (loading) {
    return (
      <ContentLoading isLoading={true} text="Đang tải thông tin trường học..." />
    );
  }
