      ...
      () => [
        {
          ...
          helperText: 'Chọn hoặc bỏ chọn các lợi ích để cập nhật gói bán.'
        }
      ],
      [benefitOptions]
    );
    ...
    return (
      <Box sx={{ height: '100%', display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
        <Typography variant="h6" gutterBottom sx={{ mb: 0.75, fontWeight: 600, fontSize: '1.1rem' }}>
          Bước {stepIndex + 1}/{totalSteps}: Điều chỉnh lợi ích
        </Typography>
        <Typography variant="body2" color="text.secondary" sx={{ mb: 1, fontSize: '0.875rem' }}>
          Cập nhật danh sách lợi ích để đảm bảo gói bán phù hợp với chính sách chi nhánh.
        </Typography>
...
Step3Benefits.displayName = 'UpdatePackageStep3Benefits';
